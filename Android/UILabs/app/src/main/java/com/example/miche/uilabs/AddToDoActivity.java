...
import com.example.miche.uilabs.ToDoItem.Priority;
import com.example.miche.uilabs.ToDoItem.Status;
...
public class AddToDoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		cancelButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO Base 3.1 - Implement onClick(). If cancel just go back to main activity.
		...
		resetButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO Base 3.2 - Reset data fields to default values
		...
		submitButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO Base 3.3 - Get Priority
				Priority priority = getPriority();
				//TODO Base 3.4 -  Get Status
				...
				//TODO Base 3.6 - return data Intent and finish
    ...
    // TODO Base 3.2 - methods to set all fields to their default values
    ...
    private void showDatePickerDialog() {
        DialogFragment newFragment = new AddToDoActivity.DatePickerFragment();
        newFragment.show(getFragmentManager(), "datePicker");
    }

    private void showTimePickerDialog() {
        DialogFragment newFragment = new AddToDoActivity.TimePickerFragment();
